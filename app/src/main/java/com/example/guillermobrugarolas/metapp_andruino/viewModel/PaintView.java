...
public class PaintView extends View {
    ...
    public static final int DEFAULT_COLOR = R.color.colorPrimary;
    public static final int DEF_BG_COLOR = Color.WHITE;
    private static final float TOUCH_TOLERANCE = 4;
    private float mX, mY;
    private Path mPath;
    private Paint mPaint;
    private ArrayList<FingerPath> paths = new ArrayList<>();
    private int currentColor = R.color.colorPrimary;
    private int backgroundColor = DEF_BG_COLOR;
