...
import com.Grupo1.MET.metapp_andruino.viewModel.LogCommViewModel;
...
public class LogCommFragment extends Fragment {
    ...
    public void bindViews(View v) throws IOException {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getContext(), android.R.layout.simple_list_item_1, logs.toArray(new String[0]));
